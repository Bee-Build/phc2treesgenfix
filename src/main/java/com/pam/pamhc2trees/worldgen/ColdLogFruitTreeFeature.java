...
public class ColdLogFruitTreeFeature extends Feature<NoFeatureConfig> {
	public ColdLogFruitTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactory) {
		super(configFactory);
	}
